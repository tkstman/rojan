<!--Modal Quick Look -->
<div class="modal fade bd-example-modal-lg" id="quicklookmodalEditProd" tabindex="-1" role="dialog" aria-labelledby="quicklookmodalEditProd" aria-hidden="true">
        ...
        <div class="row">
          <form style="margin-top: 20px; margin-bottom: 20px; margin-left: 50px; margin-right: 50px;">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="inputManufacturer" name="inputManufacturer"   value="{{Request::old('inputManufacturer')}}"/>
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn btn-primary" id="sendContactBtn">Submit</button>
            {{Form::token()}}
        </div>
      </div>
